...
class DriftGuardProxyClient:
    """Proxy-style app integration that tags requests as proxy traffic.

    This mirrors DriftGuardClient, but uses IntegrationPath.PROXY so the system can
    distinguish app traffic captured behind a reverse-proxy or gateway layer from
    direct wrapper-based SDK instrumentation.
    """
    ...
    def __init__(
        ...
        *,
        ...
        integration_path: IntegrationPath = IntegrationPath.PROXY,
        **client_kwargs: Any,
    ) -> None:
    ...
    def __enter__(self) -> "DriftGuardProxyClient":
        return self
...
def make_proxy_client(
    ...
    **client_kwargs: Any,
    ...
    """Factory returning a proxy-tagged client with capture enabled."""
...
__all__ = ["DriftGuardProxyClient", "make_proxy_client"]
